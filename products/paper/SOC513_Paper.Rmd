...
Using homeownership as an indicator of assimilation that accelerate integration, this paper presents the statistical analysis of immigrants experience between those who own home and do not. Investigating how have homeownership influences these factors and their trajectories will helps identify housing strategy.
...
```{r figure 1, echo=FALSE, fig.cap="", fig.align='center'}
...
```{r figure 2, echo=FALSE, fig.cap="", fig.align='center'}
ggplot(complete(imputations,1),
...
```{r figure 3, echo=FALSE, fig.cap="", fig.align='center'}
ggplot(complete(imputations,1),
...
```{r figure 5, echo=FALSE, fig.cap="", fig.align='center'}
ggplot(complete(imputations,1),
...
# Conclusions
Homeownership remains the key signifyier of self perception as acquiring American Dreams. However, the ownership do not positively effect immigrants' experiences. 
